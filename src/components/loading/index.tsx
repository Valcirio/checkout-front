...
const sizeCircle = tv({
	slots: {
		i_class:
			'absolute w-full h-full rounded-full border-b-primary-foreground border-t-transparent border-l-transparent border-r-transparent',
		label_class: 'relative flex',
	},
	variants: {
		size: {
			sm: { i_class: 'border-[0.2rem]', label_class: 'w-7 h-7' },
			md: { i_class: 'border-[0.3rem]', label_class: 'w-9 h-9' },
			lg: { i_class: 'border-[0.45rem]', label_class: 'w-20 h-20' },
		},
	},
